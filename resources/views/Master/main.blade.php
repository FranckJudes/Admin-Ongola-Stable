...
<body id="myBody_Ongola" class="{{Auth::user()->theme_preference ?? 'light light-sidebar theme-white'}}">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{ route('go_to_add_order_livreurs')}}">Attribuer les Commandes</a></li>
                    @if (Auth::user()->type == '1')
                         <li><a href="{{route('peformance_livreurs')}}" class="nav-link">Performances Livreurs</a></li>
                    @endif
              </ul>
            </li>
            ...
            <li class="dropdown ">
                <a href="{{route('commande.index')}}" class="nav-link"><i data-feather="monitor"></i><span>Commandes</span></a>
              </li>
              @if (Auth::user()->type == '1')
