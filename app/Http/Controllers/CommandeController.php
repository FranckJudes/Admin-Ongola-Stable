...
class CommandeController extends Controller
{
    ...
    {
        $commandeEnLivraisom = SuivieLivraison::where('etat', '1')->with('commande')->orderBy('created_at', 'desc')->paginate(50);
        $commandeEnPreparation = SuivieLivraison::where('etat', '2')->with('commande')->orderBy('created_at', 'desc')->paginate(50);
        $commandeLivree = SuivieLivraison::where('etat', '3')->with('commande')->orderBy('created_at', 'desc')->paginate(50);
        $commandeEnAnnuler = SuivieLivraison::where('etat', '4')->with('commande')->orderBy('created_at', 'desc')->paginate(50);
        ...
        try {
            ...
            if ($CommandeArray) {
                ...
                foreach ($CommandeArray as  $s) {
                    ...
                    $commande->save();
                    $g = SuivieLivraison::where('id_commande',$commande->id)->first();
                    $g->etat ='1';
                    $g->save();
