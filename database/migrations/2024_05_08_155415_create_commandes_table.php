...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('commandes', function (Blueprint $table) {
            ...
            $table->foreignId('id_receive_client')->constrained('receive_clients')->onDelete('cascade'); // id du client
            $table->foreignId('id_partenaire')->constrained('partenaires')->onDelete('cascade'); // id du partenaire
            $table->foreignId('livreur_id')->nullable()->constrained('livreurs')->onDelete('cascade'); // id du livreur
